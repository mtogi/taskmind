...
const parseTaskText = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        const { text } = req.body;
        ...
        const parsedContent = (_c = (_b = completion.choices[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
        if (!parsedContent) {
            return res.status(500).json({ message: 'Failed to parse task text.' });
        }
        // Parse the response from OpenAI
        const parsedTask = JSON.parse(parsedContent);
